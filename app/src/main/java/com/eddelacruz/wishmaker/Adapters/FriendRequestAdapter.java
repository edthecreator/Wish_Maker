...
public class FriendRequestAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   // private FriendRequestFragment friendRequestFragment;
    ...
    private FriendRequestAdapter.onRecyclerViewItemClickListener mItemClickListener;

    public FriendRequestAdapter() { }

    public FriendRequestAdapter(FriendRequestFragment friendrequestfragment, Context context, ArrayList<Friends> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FriendRequestAdapter.RequestViewHolder(view, parent.getContext(), viewType);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof FriendRequestAdapter.RequestViewHolder) {
            try {
                FriendRequestAdapter.RequestViewHolder v = (FriendRequestAdapter.RequestViewHolder) holder;
    ...
    private class RequestViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ImageView reject = (ImageView) itemView.findViewById(R.id.reject);
    ...
    public void setOnItemClickListener(FriendRequestAdapter.onRecyclerViewItemClickListener mItemClickListener) {
